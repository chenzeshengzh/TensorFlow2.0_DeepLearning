...
+ 数据集
  ...
  > CIFAR10经典图片数据集：包含飞机、汽车、鸟、猫等10类物体的彩色图片；每个种类收集6000张$32 \times 32$的图片，其中5万张作为训练集，1万张作为测试集。
...
+ 网络模型
  ...
  \begin{aligned}
  input 
  &\rightarrow \underbrace{conv2d(64, 3 \times 3) \rightarrow conv2d(64, 3 \times 3) \rightarrow pool2d(2 \times 2, 2)}_{conv-pool} \\\\
  &\rightarrow \lbrace{conv-pool}\rbrace * 4
  \rightarrow fc(256) \rightarrow fc(64) \rightarrow fc(10)
  \end{aligned}
  $$
